...
public class new_WeatherAPIScript : MonoBehaviour
{
    public GameObject weatherTextObject;
        // add your personal API key after APPID= and before &units=
       string url = "http://api.openweathermap.org/data/2.5/weather?lat=12.29&lon=76.64&APPID=efd7b81184f5887298b81a06660313c5&units=metric";
